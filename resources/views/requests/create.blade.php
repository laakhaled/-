            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @else
                            <p>ليس لديك صلاحية لإنشاء طلب.</p>
                        @endif
                    </div>
                </div>
            </div>
                ...
                @foreach ($requests as $request)
                    ...
                    <div class="modal fade" id="deleteRequestModal{{ $request->id }}" tabindex="-1" aria-labelledby="deleteRequestModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="deleteRequestModalLabel">Are you sure you want to delete this request?</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="/requests/delete/{{ $request->id }}" method="POST">                                        @csrf
                                        @method('DELETE')
